...
local SCREENS_TO_REMOVE = {
  ...
  ['UI/Flow/Screen/HudMPScreen'] = {
    'HudMessageKills', 'ScoreMessage', 'ScoreAggregator', 'HudInformationMessage'
  },
  ['UI/Flow/Screen/HudTDMScreen'] = {
    'TicketCounter', 'HudBackgroundWidget', 'Compass', 'LocalKillMessage', 'SquadList'
  },
...
local applyUIModifications = function()
